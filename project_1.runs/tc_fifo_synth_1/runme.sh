...
HD_PWD='C:/Users/Simone Ragoni/alice/CTPv15/ctp3-fw-ctpreadout-simulations/project_1.runs/tc_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tc_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tc_fifo.tcl

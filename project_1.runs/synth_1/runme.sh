...
HD_PWD='C:/Users/Simone Ragoni/alice/CTPv15/ctp3-fw-ctpreadout-simulations/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ctpreadout.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ctpreadout.tcl

...
HD_PWD='C:/Users/Simone Ragoni/alice/CTPv15/ctp3-fw-ctpreadout-simulations/project_1.runs/dc_fifo_gbt2olt_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dc_fifo_gbt2olt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dc_fifo_gbt2olt.tcl

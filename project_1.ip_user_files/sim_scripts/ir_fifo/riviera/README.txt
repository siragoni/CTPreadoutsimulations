...
#
# Generated by export_simulation on Fri Jun 24 14:12:12 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './ir_fifo.sh' script.

./ir_fifo.sh -reset_run
...
./ir_fifo.sh -noclean_files

For more information on the script, please type './ir_fifo.sh -help'.
